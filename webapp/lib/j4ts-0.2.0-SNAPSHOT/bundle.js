...
(function (test) {
    var Test = (function () {
        ...
        Test.testList = function () {
            ...
            var res = "";
            for (var index124 = l.iterator(); index124.hasNext();) {
                var s = index124.next();
                {
                    res += s;
                }
            ...
            Applet.__static_initializer_0 = function () {
                ...
                window.onload = function (e) {
                    ...
                    if (div.getAttribute("data-applet") != null) {
                        ...
                        for (var index125 = 0; index125 < names.length; index125++) {
                            var name = names[index125];
                            {
            ...
            var Logger = (function () {
                ...
                Logger.prototype.actuallyLog$java_util_logging_LogRecord = function (record) {
                    if (this.isLoggable(record.getLevel())) {
                        ...
                        while ((logger != null)) {
                            {
                                var array129 = logger.getHandlers();
                                for (var index128 = 0; index128 < array129.length; index128++) {
                                    var handler = array129[index128];
                                    {
                                        handler.publish(record);
                                    }
                                }
    ...
    (function (util) {
        ...
        var AbstractMap = (function () {
            ...
            AbstractMap.prototype.containsValue = function (value) {
                for (var index144 = this.entrySet().iterator(); index144.hasNext();) {
                    var entry = index144.next();
                    {
            ...
            AbstractMap.prototype.equals = function (obj) {
                ...
                for (var index145 = otherMap.entrySet().iterator(); index145.hasNext();) {
                    var entry = index145.next();
                    {
            ...
            AbstractMap.prototype.putAll = function (map) {
                ...
                for (var index146 = map.entrySet().iterator(); index146.hasNext();) {
                    var e = index146.next();
                    {
            ...
            AbstractMap.prototype.toString$ = function () {
                var joiner = new java.util.StringJoiner(", ", "{", "}");
                for (var index147 = this.entrySet().iterator(); index147.hasNext();) {
                    var entry = index147.next();
                    {
    ...
    (function (util) {
        ...
        var EnumMap = (function (_super) {
            ...
            EnumMap.prototype.containsValue = function (value) {
                for (var index149 = this.__keySet.iterator(); index149.hasNext();) {
                    var key = index149.next();
                    {
    ...
    (function (util) {
        ...
        var Vector = (function (_super) {
            ...
            Vector.prototype.forEach = function (action) {
                javaemul.internal.InternalPreconditions.checkNotNull(action);
                for (var index151 = this.iterator(); index151.hasNext();) {
                    var t = index151.next();
                    {
                        action(t);
                    }
    ...
    (function (util) {
        ...
        var Collections = (function () {
            ...
            Collections.copy = function (dest, src) {
                ...
                for (var index153 = src.iterator(); index153.hasNext();) {
                    var e = index153.next();
                    {
                        destIt.next();
                        destIt.set(e);
            ...
            Collections.disjoint = function (c1, c2) {
                ...
                for (var index154 = iterating.iterator(); index154.hasNext();) {
                    var o = index154.next();
                    {
            ...
            Collections.frequency = function (c, o) {
                var count = 0;
                for (var index155 = c.iterator(); index155.hasNext();) {
                    var e = index155.next();
                    {
                        if (java.util.Objects.equals(o, e)) {
                            ++count;
            ...
            Collections.shuffle = function (list, rnd) {
                ...
                if (list != null && list["__interfaces"] != null && list["__interfaces"].indexOf("java.util.RandomAccess") >= 0) {
                    ...
                    for (var index156 = 0; index156 < arr.length; index156++) {
                        var e = arr[index156];
                        {
                            it.next();
                            it.set(e);
            ...
            Collections.hashCode$java_lang_Iterable = function (collection) {
                var hashCode = 0;
                for (var index157 = collection.iterator(); index157.hasNext();) {
                    var e = index157.next();
                    {
            ...
            Collections.hashCode = function (list) {
                if (((list != null && list["__interfaces"] != null && list["__interfaces"].indexOf("java.util.List") >= 0) || list === null)) {
                    return (function () {
                        var hashCode = 1;
                        for (var index158 = list.iterator(); index158.hasNext();) {
                            var e = index158.next();
                            {
        ...
        (function (Collections) {
            ...
            var UnmodifiableMap = (function () {
                ...
                UnmodifiableMap.prototype.put$java_lang_Object$java_lang_Object = function (key, value) {
                    throw new java.lang.UnsupportedOperationException();
                };
    ...
    (function (util) {
        ...
        var AbstractHashMap = (function (_super) {
            ...
            AbstractHashMap.prototype._containsValue = function (value, entries) {
                for (var index163 = entries.iterator(); index163.hasNext();) {
            ...
            AbstractHashMap.prototype.put$java_lang_Object$java_lang_Object = function (key, value) {
    ...
    (function (util) {
        ...
        var Arrays = (function () {
            ...
            Arrays.hashCode$int_A = function (a) {
                ...
                var hashCode = 1;
                for (var index173 = 0; index173 < a.length; index173++) {
                    var e = a[index173];
                    {
            ...
            Arrays.hashCode$long_A = function (a) {
                ...
                var hashCode = 1;
                for (var index174 = 0; index174 < a.length; index174++) {
                    var e = a[index174];
                    {
            ...
            Arrays.toString$byte_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index178 = 0; index178 < a.length; index178++) {
                    var element = a[index178];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$char_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index179 = 0; index179 < a.length; index179++) {
                    var element = a[index179];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$double_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index180 = 0; index180 < a.length; index180++) {
                    var element = a[index180];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$float_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index181 = 0; index181 < a.length; index181++) {
                    var element = a[index181];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$int_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index182 = 0; index182 < a.length; index182++) {
                    var element = a[index182];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$long_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index183 = 0; index183 < a.length; index183++) {
                    var element = a[index183];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
            ...
            Arrays.toString$short_A = function (a) {
                ...
                var joiner = new java.util.StringJoiner(", ", "[", "]");
                for (var index184 = 0; index184 < a.length; index184++) {
                    var element = a[index184];
                    {
                        joiner.add(/* valueOf */ new String(element).toString());
                    }
                }
